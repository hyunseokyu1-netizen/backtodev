...
![스크린샷 2026-04-15 오후 12.06.48](https://raw.githubusercontent.com/hyunseokyu1-netizen/backtodev/main/public/images/___________2026-04-15______12_06_48_1776222674014.png)
-> 이렇게 등록을 해도, 신원 확인중이 뜨고, 바로 승인이 안됨. 내가 초창기에 바로 등록할 수 있었던거와는 완전 다른게 된거 같다.
> 구글 정책이 복잡해져서 신원인증, 청구서 등록 등 주소지 확인이 필요함.   
그래서 일정기간이 소요됨.   
 >> 프로젝트 일정이 짧으면, 앱 개발 전에 미리 스토어 등록 필요함.
